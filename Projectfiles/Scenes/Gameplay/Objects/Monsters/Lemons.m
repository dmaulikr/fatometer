...
@implementation Lemons
- (id)initWithMonsterPicture
{
    self = [super initWithFile:@"lemons.png"];
...
- (void)gotCollected {
    ...
    [[GameMechanics sharedGameMechanics] game].fatness = [[GameMechanics sharedGameMechanics] game].fatness -= 0;
